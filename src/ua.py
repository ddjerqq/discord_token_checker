...
USER_AGENTS = (
    ...
    "Mozilla/4.0 compatible ZyBorg/1.0 (wn-14.zyborg@looksmart.net; https://www.WISEnutbot.com)",
    "Mozilla/4.0 compatible ZyBorg/1.0 (wn-16.zyborg@looksmart.net; https://www.WISEnutbot.com)",
    "Mozilla/4.0 compatible ZyBorg/1.0 Dead Link Checker (wn.dlc@looksmart.net; https://www.WISEnutbot.com)",
    "Mozilla/4.0 compatible ZyBorg/1.0 Dead Link Checker (wn.zyborg@looksmart.net; https://www.WISEnutbot.com)",
    "Mozilla/4.0(compatible; MSIE 5.0; Windows 98; DigExt)",
    "Mozilla/4.0(compatible; MSIE 7.0b; Windows NT 6.0)",
    ...
    "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/532.0 (KHTMLlike Gecko) Chrome/3.0.195.27",
    ...
    "Mozilla/5.0 (X11; U; Linux x86_64; en-US) AppleWebKit/540.0 (KHTMLlike Gecko) Chrome/9.1.0.0 Safari/540.0",
    ...
    "Mozilla/5.0 (compatible, MSIE 11, Windows NT 6.3; Trident/7.0;  rv:11.0) like Gecko",
    "Mozilla/5.0 (compatible; 008/0.83; https://www.80legs.com/webcrawler.html) Gecko/2008032620",
    "Mozilla/5.0 (compatible; AbiLogicBot/1.0; +https://www.abilogic.com/bot.html)",
    "Mozilla/5.0 (compatible; AnyApexBot/1.0; +https://www.anyapex.com/bot.html)",
    "Mozilla/5.0 (compatible; Baiduspider/2.0; +https://www.baidu.com/search/spider.html)",
    "Mozilla/5.0 (compatible; BecomeBot/2.3; MSIE 6.0 compatible; +https://www.become.com/site_owners.html)",
    ...
    "Mozilla/5.0 (compatible; Yahoo! Slurp China; https://misc.yahoo.com.cn/help.html)",
    ...
    "Mozilla/5.0 (compatible; YandexImages/3.0; +https://yandex.com/bots)",
    "Mozilla/5.0 (compatible; YodaoBot/1.0; https://www.yodao.com/help/webmaster/spider/; )",
    ...
    "Mozilla/5.0 (iPhone; U; CPU iPhone OS) (compatible; Googlebot-Mobile/2.1;  https://www.google.com/bot.html)",
    ...
    "NutchCVS/0.8-dev (Nutch running at UW; https://www.nutch.org/docs/en/bot.html; sycrawl@cs.washington.edu)",
    ...
    "Opera/9.61 (Windows NT 6.0; U; https://lucideer.com; en-GB) Presto/2.1.1",
...
def signed_header(token: str, **kwargs: ...) -> dict[str, str]:
    headers = BASE.copy()
